...
const PDFButton = () => {
  const generatePDF = () => {
    const report = new JsPDF({ putOnlyUsedFonts: true, orientation: "landscape" });
    ...
    <>
      <div>
        <table style={{ width: "200px", tableLayout: "fixed" }} id="report">
          ...
          <tbody>
            <tr>
              <td style={{ width: "10%" , fontSize: '10px'}}>Alfreds Futterkiste</td>
              <td style={{ width: "10%" , fontSize: '10px'}}>Maria Anders</td>
              <td style={{ width: "10%" , fontSize: '10px'}}>Germany</td>
            </tr>
            <tr>
              <td style={{ width: "10%" , fontSize: '10px'}}>Centro comercial Moctezuma</td>
              <td style={{ width: "10%" , fontSize: '10px'}}>Francisco Chang</td>
            ...
            <tr>
              <td style={{ width: "10%" , fontSize: '10px'}}>Laughing Bacchus Winecellars</td>
              <td style={{ width: "10%" , fontSize: '10px'}}>Yoshi Tannamuri</td>
              <td style={{ width: "10%" , fontSize: '10px'}}>Canada</td>
            </tr>
            <tr>
              <td style={{ width: "10%" , fontSize: '10px'}}>Magazzini Alimentari Riuniti</td>
              <td style={{ width: "10%" , fontSize: '10px'}}>Giovanni Rovelli</td>
